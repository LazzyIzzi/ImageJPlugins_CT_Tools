...
public class Xray_Calculator implements PlugIn, ActionListener, DialogListener {
	...
	// The default width and height of the attenuation solutions table
	...
	private void UpdateResults() {
		...
		try {
			...
			if (fl != null && myKeV > 0.001 && myKeV < 100000) {
				...
				try {
					rt.addValue("Linear Attn cm" + (char) 0x207b + (char) 0x0b9,
							ds.gmPerCC * mmc.getMuMass(ds.formula, myKeV / 1000, mmTypes[0]));
